<template>
  ...
  >
    <div class="title">
      <span class="title-name">在线base64加密</span>
    </div>
...
export default {
  ...
  methods: {
    makeQrcode () {
      ...
      // this.result = Base64(this.inputVal).toString()
      const wordArray = CryptoJS.enc.Utf8.parse(this.inputVal);
      //  var base64 =  CryptoJS.enc.Base64.stringify(wordArray);
      this.result = CryptoJS.enc.Base64.stringify(wordArray)
